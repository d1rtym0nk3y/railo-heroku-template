<?xml version="1.0" encoding="UTF-8"?><railo-configuration version="2.0"><cfabort/>
...
<!--	or ask your database distributor 																-->
    ...
    <remote-clients directory="{railo-web}/remote-client/" log="{railo-web}/logs/remote-client.log" log-level="info"/>
...
<!--
		<mapping archive="" physical="../../src/" primary="physical" readonly="true" trusted="false" virtual="/"/>
-->		
		<mapping archive="" physical="WEB-INF/lib/railo-server/" primary="physical" readonly="true" trusted="false" virtual="/WEB-INF/lib/railo-server"/>
	</mappings>
	...
	<!--
	 ...
	 -->
	<debugging debug="false" memory-log="{railo-web}/logs/memory.log" template="/railo-context/templates/debugging/debugging.cfm"/>
